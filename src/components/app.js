...
class App extends Component {
    ...
    checkBook = (ricerca) => {
        ...
        var cardNull = [];
            ...
            for (var i = 0; i < this.state.viewMax; i++) {
    ...
    setViewmax = (view) =>{
        this.setState({viewMax:view});
        var x = 40/view;
        //era brutto da vedere nella barra << |1|2|2| >>
        //meglio avere << |1|2|max| >>
        if(x==2)
        {
            x="max"
        }
                        ...
                        <div className='home-search-page py-2'>
                            <nav aria-label="Page navigation example" className='d-flex justify-content-center align-items-center'>
                                <ul className="pagination">
                                    ...
                                    <li className="page-item"><a className="page-link text-black" >1</a></li>
                                    <li className="page-item"><a className="page-link text-black" >2</a></li>
                                    <li className="page-item"><a className="page-link text-black" >{this.state.page}</a></li>
                                    <li className="page-item">
